...
internal class _7_Tools_Middleware : BaseSample
{
    public override string Description => "Added Tools Middleware";
    ...
    public override async Task RunAsync()
    {
        ...
        var agent = AgentClientFactory
             .GetAgent(Enums.Clients.Github, Models.OpenAI.GPT_4o_MINI, tools: tools, withMiddleware: true);
