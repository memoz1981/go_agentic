...
internal class _29_Workflows_Optimized_Claude : BaseSample
{
    public override string Description => "Optimized appointment workflow - WITH CLAUDE";
    ...
    private readonly AppointmentWorkflowFactory_Claude _agentFactory;
    ...
    public _29_Workflows_Optimized_Claude()
    {
